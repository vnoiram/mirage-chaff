...
func TestAdminUISmokeIncludesAnalyticsAndCatalogActions(t *testing.T) {
	...
	for _, want := range []string{
		...
		"managedSourcePreviewResultHTML",
		"managedSourceDetailHTML",
		"AGH_MANAGED_SOURCE_DETAIL_KIND",
		"AGH_MANAGED_SOURCE_PREVIEW_RESULT",
		"AGH_MANAGED_SOURCE_PREVIEW_STATE",
		"agh-source-preview-status",
		"previewing source",
		...
		"AGH_MANAGED_PENDING_DIFF_RESULT",
		"managedPendingDiffResultHTML",
		"agh-pending-diff-status",
		"loading pending diff",
		"pending diff ready",
		...
		"restoreManagedSourceEntryRows",
		"AGH_SOURCE_ENTRY_STATE",
		"managedSourceEntriesResultHTML",
		"agh-source-entry-status",
		"loading source entries",
		"source entries loaded",
		"managedSourceOperationResultHTML",
		"setManagedSourceResult",
		"managedSourceOperationError",
		"AGH_MANAGED_SOURCE_RESULT",
		"agh-source-result",
		"agh-source-status",
		...
		"managedHistoryActionValues",
		"managedHistoryActionFilter",
		"managedHistoryActionSummary",
		"filterManagedHistory",
		"agh-history-kind",
		"agh-history-action",
		"agh-history-count",
		"agh-history-kind-summary",
		"agh-history-action-summary",
		"data-history-action",
		...
		"managedTargetResultHTML",
		"AGH_MANAGED_TARGET_REFRESH_RESULT",
		"AGH_MANAGED_TARGET_CONFIG_RESULT",
		"agh-target-status",
		...
		"Apply reload",
		"managedConfigReloadResultHTML",
		"AGH_MANAGED_CONFIG_RELOAD_RESULT",
		"applyManagedConfigReload",
		"agh-reload-result",
		"agh-reload-status",
		"applying reload",
		"reload applied",
		...
		"managedSchedulerResultHTML",
		"AGH_MANAGED_SCHEDULER_CONFIG_RESULT",
		"agh-scheduler-status",
		"scheduler settings saved",
		"saving scheduler settings",
		...
		"managedAGHRegistrationResultHTML",
		"AGH_MANAGED_REGISTRATION_RESULT",
		...
		"updateManagedCatalogSelectionCount",
		"agh-bulk-selection-count",
		"selected /",
		"managedCatalogActionResultHTML",
		"setManagedCatalogActionResult",
		"managedCatalogActionError",
		"AGH_MANAGED_CATALOG_RESULT",
		"agh-catalog-result",
		"agh-catalog-status",
		"catalog action complete",
		"exportManagedFeedSnapshot",
		"managedFeedExportResultHTML",
		"AGH_MANAGED_FEED_EXPORT_RESULT",
		"agh-feed-export-result",
		"agh-feed-export-status",
		"exporting snapshot",
		"snapshot exported",
		...
		"agh-bulk-action",
		"agh-bulk-notes",
		"managedCatalogBulkResultHTML",
		"agh-bulk-result",
		"agh-bulk-status",
		"AGH_MANAGED_BULK_RESULT",
		"bulk edit applied",
		"applying bulk edit",
		"expected catalog",
		"original_rule",
